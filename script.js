...
//stop and go - scrolling. Currently doesn't disable the slider - it should. I'm too lazy though
    const stopAndGo = document.getElementById('stopAndGo');
    stopAndGo.addEventListener('click', (e)=>{
        if(gameSpeed !== 0){
            storedSpeed = gameSpeed;
            gameSpeed = 0;
            stopAndGo.innerHTML = "Go";
        } else {
            gameSpeed = storedSpeed;
            storedSpeed = null;
            stopAndGo.innerHTML = "Stop";
        }
    })
